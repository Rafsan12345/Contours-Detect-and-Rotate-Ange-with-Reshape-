...
for i, cnt in enumerate(contours):
    if cv2.contourArea(cnt) > 200:  # Ignore small noise
        ...
        cv2.drawContours(rotated_img, [rotated_cnt], -1, (0, 255, 0), -1)  # -1 means fill
...
cv2.imwrite("new.jpg", rotated_img_resized)  # এই লাইন নতুন ফাইল save করবে
